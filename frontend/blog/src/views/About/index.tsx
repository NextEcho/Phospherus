        ...
        <div className="upper flex flex-row flex-1 justify-around px-20 py-10 mx-24 my-10 h-64">
          <div className="owner-outline flex">
            <div className="avatar">
              <img src={avatar} alt="" className="w-48 h-48 object-cover rounded-full" />
            </div>
        ...
        <div className="lower flex flex-row flex-1 px-20 py-10 mx-24 my-10 h-96 font-code">
          <div className="detail basis-2/3 pr-20 text-base">
            <p className="">
              ...
              detail about blog owner, you can put discripition in this zone. This is detail about
              blog owner, you can put discripition in this zone. This is detail about blog owner,
            ...
            <div className="contact">
              ...
              <ul>
                <li className="mx-2 mt-2 cursor-pointer">
                  Mail: <a className="hover:underline underline-offset-4 hover:text-indigo-400 decoration-indigo-400">nextecho@outlook.com</a>
                </li>
              </ul>
            </div>
            <Divider />
